...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), 'Shubham')
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/p_Test 13 user'))
